...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__50002,k,f){
var vec__50004 = p__50002;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50004,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50004,(1),null);
var loc = vec__50004;
...
var G__50031 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__50031;
continue;
}
break;
...
var G__50032 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__50032;
continue;
} else {
return zloc__$1;
...
var G__50033 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__50033;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__50012){
var vec__50013 = p__50012;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50013,(0),null);
var map__50016 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50013,(1),null);
var map__50016__$1 = (((((!((map__50016 == null))))?(((((map__50016.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50016.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__50016):map__50016);
var path = map__50016__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50016__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__50013;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__50018){
var vec__50019 = p__50018;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50019,(0),null);
var map__50022 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50019,(1),null);
...
var path = map__50022__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50022__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__50019;
if(cljs.core.seq(r)){
...
var vec__50024 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50024,(0),null);
var map__50027 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50024,(1),null);
...
var path = map__50027__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50027__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50027__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50027__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50027__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
