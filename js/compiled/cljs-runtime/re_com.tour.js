...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__63774_SHARP_,p2__63775_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__63774_SHARP_,p2__63775_SHARP_,reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false));
}),tour_map,tour_spec);
});
/**
...
return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function re_com$tour$initialise_tour_$_iter__63779(s__63780){
return (new cljs.core.LazySeq(null,(function (){
var s__63780__$1 = s__63780;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__63780__$1);
if(temp__5735__auto__){
var s__63780__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63780__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__63780__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63782 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63781 = (0);
while(true){
if((i__63781 < size__4581__auto__)){
var step = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63781);
cljs.core.chunk_append(b__63782,cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false));

var G__63796 = (i__63781 + (1));
i__63781 = G__63796;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63782),re_com$tour$initialise_tour_$_iter__63779(cljs.core.chunk_rest(s__63780__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63782),null);
}
} else {
var step = cljs.core.first(s__63780__$2);
return cljs.core.cons(cljs.core.reset_BANG_((step.cljs$core$IFn$_invoke$arity$1 ? step.cljs$core$IFn$_invoke$arity$1(tour) : step.call(null,tour)),false),re_com$tour$initialise_tour_$_iter__63779(cljs.core.rest(s__63780__$2)));
}
} else {
return null;
}
...
return cljs.core.reset_BANG_((function (){var fexpr__63787 = cljs.core.first(new cljs.core.Keyword(null,"steps","steps",-128433302).cljs$core$IFn$_invoke$arity$1(tour));
return (fexpr__63787.cljs$core$IFn$_invoke$arity$1 ? fexpr__63787.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__63787.call(null,tour));
})(),true);
});
/**
...
cljs.core.reset_BANG_((function (){var fexpr__63789 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__63789.cljs$core$IFn$_invoke$arity$1 ? fexpr__63789.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__63789.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__63790 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__63790.cljs$core$IFn$_invoke$arity$1 ? fexpr__63790.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__63790.call(null,tour));
})(),true);
} else {
return null;
}
...
cljs.core.reset_BANG_((function (){var fexpr__63791 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,old_step);
return (fexpr__63791.cljs$core$IFn$_invoke$arity$1 ? fexpr__63791.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__63791.call(null,tour));
})(),false);

return cljs.core.reset_BANG_((function (){var fexpr__63792 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(steps,new_step);
return (fexpr__63792.cljs$core$IFn$_invoke$arity$1 ? fexpr__63792.cljs$core$IFn$_invoke$arity$1(tour) : fexpr__63792.call(null,tour));
})(),true);
} else {
return null;
}
