...
if((i < len)){
var k = (ks[i]);
var G__46583 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__46584 = (i + (1));
m = G__46583;
i = G__46584;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__46500 = p.children;
return module$node_modules$react$index.Children.toArray(G__46500);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__46503 = c;
var G__46503__$1 = (((G__46503 == null))?null:G__46503.prototype);
if((G__46503__$1 == null)){
return null;
} else {
return G__46503__$1.reagentRender;
}
})() == null)))));
});
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__46509 = c;
var G__46509__$1 = (((G__46509 == null))?null:G__46509.prototype);
if((G__46509__$1 == null)){
return null;
} else {
return G__46509__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__46607__delegate = function (args){
var G__46512 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__46512) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.as_element.call(null,G__46512));
};
...
while (G__46608__i < G__46608__a.length) {G__46608__a[G__46608__i] = arguments[G__46608__i + 0]; ++G__46608__i;}
  args = new cljs.core.IndexedSeq(G__46608__a,0,null);
} 
return G__46607__delegate.call(this,args);};
G__46607.cljs$lang$maxFixedArity = 0;
G__46607.cljs$lang$applyTo = (function (arglist__46609){
var args = cljs.core.seq(arglist__46609);
return G__46607__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__46513 = day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__46514 = c;
(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__46514);
...
}finally {(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__46513);
}});
...
var c = this;
var G__46528_46627 = goog.object.get(c,"cljsRatom");
if((G__46528_46627 == null)){
} else {
day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.dispose_BANG_(G__46528_46627);
}
...
var renders_46628 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_46629 = cljs.core.first(cljs.core.vals(renders_46628));
...
if((cljs.core.count(renders_46628) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_46628))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_46629)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_46629], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__46536 = o;
var G__46537_46630 = G__46536;
var G__46538_46631 = cljs.core.name(k);
var G__46539_46632 = v;
goog.object.set(G__46537_46630,G__46538_46631,G__46539_46632);
...
var G__46543_46652 = cmp.prototype;
var G__46544_46653 = module$node_modules$react$index.Component.prototype;
var G__46545_46654 = methods$;
goog.object.extend(G__46543_46652,G__46544_46653,G__46545_46654);
...
var name = (function (){var G__46549 = fiber;
var G__46549__$1 = (((G__46549 == null))?null:G__46549.type);
if((G__46549__$1 == null)){
return null;
} else {
return G__46549__$1.displayName;
}
})();
var parent = (function (){var G__46550 = fiber;
if((G__46550 == null)){
return null;
} else {
return G__46550.return;
}
})();
var path = (function (){var G__46551 = parent;
var G__46551__$1 = (((G__46551 == null))?null:(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__46551) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.fiber_component_path.call(null,G__46551)));
if((G__46551__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46551__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__46556 = c;
if((G__46556 == null)){
return null;
} else {
return goog.object.get(G__46556,"_reactInternalFiber");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__46557._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__46559 = c;
if((G__46559 == null)){
return null;
} else {
return goog.object.get(G__46559,"_reactInternalInstance");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__46561 = c;
if((G__46561 == null)){
return null;
} else {
return G__46561._reactInternalInstance;
}
})();
if(cljs.core.truth_(or__4185__auto____$1)){
return or__4185__auto____$1;
...
var elem = (function (){var or__4185__auto__ = (function (){var G__46563 = instance;
if((G__46563 == null)){
return null;
} else {
return goog.object.get(G__46563,"_currentElement");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__46564 = instance;
if((G__46564 == null)){
return null;
} else {
return G__46564._currentElement;
}
}
})();
var name = (function (){var G__46565 = elem;
var G__46565__$1 = (((G__46565 == null))?null:G__46565.type);
if((G__46565__$1 == null)){
return null;
} else {
return G__46565__$1.displayName;
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__46570 = elem;
if((G__46570 == null)){
return null;
} else {
return goog.object.get(G__46570,"_owner");
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__46571._owner;
}
}
})();
var path = (function (){var G__46572 = owner;
var G__46572__$1 = (((G__46572 == null))?null:(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__46572) : day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.component.component_path.call(null,G__46572)));
if((G__46572__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46572__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__46574 = c;
var G__46574__$1 = (((G__46574 == null))?null:G__46574.constructor);
if((G__46574__$1 == null)){
return null;
} else {
return day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.impl.util.fun_name(G__46574__$1);
}
}
})();
