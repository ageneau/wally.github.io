...
var G__52831 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","load-epoch","epochs/load-epoch",166872985),id], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__52831) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.dispatch.call(null,G__52831));
...
var all_events = cljs.core.deref((function (){var G__52833 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","all-events-by-id","epochs/all-events-by-id",-1225664812)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__52833) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.call(null,G__52833));
})());
var current_id = cljs.core.deref((function (){var G__52834 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","current-epoch-id","epochs/current-epoch-id",-482598682)], null);
return (day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__52834) : day8.re_frame_10x.inlined_deps.re_frame.v0v11v0.re_frame.core.subscribe.call(null,G__52834));
})());
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"history-list",new cljs.core.Keyword(null,"height","height",1025178622),"20%",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__4582__auto__ = (function day8$re_frame_10x$view$history$render_$_iter__52835(s__52836){
return (new cljs.core.LazySeq(null,(function (){
var s__52836__$1 = s__52836;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__52836__$1);
if(temp__5735__auto__){
var s__52836__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__52836__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__52836__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__52838 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__52837 = (0);
while(true){
if((i__52837 < size__4581__auto__)){
var vec__52843 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__52837);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52843,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52843,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
cljs.core.chunk_append(b__52838,cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__52849 = (i__52837 + (1));
i__52837 = G__52849;
continue;
} else {
var G__52850 = (i__52837 + (1));
i__52837 = G__52850;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__52838),day8$re_frame_10x$view$history$render_$_iter__52835(cljs.core.chunk_rest(s__52836__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__52838),null);
}
} else {
var vec__52846 = cljs.core.first(s__52836__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52846,(0),null);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52846,(1),null);
if(cljs.core.truth_(cljs.core.not_empty(event))){
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.history.history_item,event,id,current_id], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$history$render_$_iter__52835(cljs.core.rest(s__52836__$2)));
} else {
var G__52851 = cljs.core.rest(s__52836__$2);
s__52836__$1 = G__52851;
continue;
}
}
} else {
