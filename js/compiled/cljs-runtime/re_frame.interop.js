...
return [(function (){var pred__52167 = cljs.core.instance_QMARK_;
var expr__52168 = reactive_val;
if(cljs.core.truth_((pred__52167.cljs$core$IFn$_invoke$arity$2 ? pred__52167.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__52168) : pred__52167.call(null,reagent.ratom.RAtom,expr__52168)))){
return "ra";
} else {
if(cljs.core.truth_((pred__52167.cljs$core$IFn$_invoke$arity$2 ? pred__52167.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__52168) : pred__52167.call(null,reagent.ratom.RCursor,expr__52168)))){
return "rc";
} else {
if(cljs.core.truth_((pred__52167.cljs$core$IFn$_invoke$arity$2 ? pred__52167.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__52168) : pred__52167.call(null,reagent.ratom.Reaction,expr__52168)))){
return "rx";
} else {
if(cljs.core.truth_((pred__52167.cljs$core$IFn$_invoke$arity$2 ? pred__52167.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__52168) : pred__52167.call(null,reagent.ratom.Track,expr__52168)))){
return "tr";
} else {
return "other";
}
