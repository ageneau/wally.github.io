...
var periods__$1 = cljs.core.vec((function (){var G__63047 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__63045_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__63045_SHARP_,(0),(3));
}),G__63047);
} else {
return G__63047;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__63055){
var vec__63056 = p__63055;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63056,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63056,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__63059 = pattern;
switch (G__63059) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63059)].join('')));
...
var G__63068 = key;
var G__63068__$1 = (((G__63068 instanceof cljs.core.Keyword))?G__63068.fqn:null);
switch (G__63068__$1) {
case "millis":
return (function (p1__63060_SHARP_){
return p1__63060_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__63061_SHARP_){
return p1__63061_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__63062_SHARP_){
return p1__63062_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__63063_SHARP_){
return p1__63063_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__63064_SHARP_){
return p1__63064_SHARP_.getHours();
});

break;
case "day":
return (function (p1__63065_SHARP_){
return p1__63065_SHARP_.getDate();
});

break;
case "month":
return (function (p1__63066_SHARP_){
return p1__63066_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__63067_SHARP_){
return p1__63067_SHARP_.getYear();
});

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63068__$1)].join('')));

}
});
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__63072){
var vec__63073 = p__63072;
var seq__63074 = cljs.core.seq(vec__63073);
var first__63075 = cljs.core.first(seq__63074);
var seq__63074__$1 = cljs.core.next(seq__63074);
var key = first__63075;
var args = seq__63074__$1;
var G__63076 = key;
...
break;
case "ordinal-suffix":
var vec__63077 = (function (){var G__63080 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__63080) : syntax_list.call(null,G__63080));
})();
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63077,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63076__$1)].join('')));
...
var d = value;
var G__63084 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__63085 = G__63084;
...
var unparser = first__63087;
var more = seq__63086__$1;
var s = "";
var d__$1 = d;
var G__63084__$1 = G__63084;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__63095 = G__63084__$1;
var seq__63096 = cljs.core.seq(vec__63095);
var first__63097 = cljs.core.first(seq__63096);
var seq__63096__$1 = cljs.core.next(seq__63096);
var unparser__$1 = first__63097;
var more__$1 = seq__63096__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__63098 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63098,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63098,(1),null);
var G__63164 = d__$3;
var G__63165 = more__$1;
var G__63166 = s__$3;
d__$1 = G__63164;
G__63084__$1 = G__63165;
s__$1 = G__63166;
continue;
}
break;
