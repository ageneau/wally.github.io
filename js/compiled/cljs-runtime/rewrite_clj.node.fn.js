...
var syms = (function (){var iter__4582__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__49077(s__49078){
return (new cljs.core.LazySeq(null,(function (){
var s__49078__$1 = s__49078;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__49078__$1);
if(temp__5735__auto__){
var s__49078__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49078__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__49078__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__49080 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__49079 = (0);
while(true){
if((i__49079 < size__4581__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__49079);
...
cljs.core.chunk_append(b__49080,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__49158 = (i__49079 + (1));
i__49079 = G__49158;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49080),rewrite_clj$node$fn$fn_walk_$_iter__49077(cljs.core.chunk_rest(s__49078__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49080),null);
}
} else {
var i = cljs.core.first(s__49078__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__49077(cljs.core.rest(s__49078__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__49076_SHARP_){
var or__4185__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__49076_SHARP_);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return p1__49076_SHARP_;
}
}),form);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k49082,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49082,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__49092){
var vec__49093 = p__49092;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49093,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49093,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49081){
var self__ = this;
var G__49081__$1 = this;
return (new cljs.core.RecordIter((0),G__49081__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__49098 = (function (coll__4436__auto__){
return (-1740346885 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__49098(this__4435__auto____$1);
})();
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49083,other49084){
var self__ = this;
var this49083__$1 = this;
return (((!((other49084 == null)))) && ((this49083__$1.constructor === other49084.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49083__$1.children,other49084.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49083__$1.__extmap,other49084.__extmap)));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__49081){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__49099 = cljs.core.keyword_identical_QMARK_;
var expr__49100 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__49102 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__49103 = expr__49100;
return (pred__49099.cljs$core$IFn$_invoke$arity$2 ? pred__49099.cljs$core$IFn$_invoke$arity$2(G__49102,G__49103) : pred__49099.call(null,G__49102,G__49103));
})())){
return (new rewrite_clj.node.fn.FnNode(G__49081,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__49081),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__49081){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__49081,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__49085){
var extmap__4478__auto__ = (function (){var G__49104 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__49085,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__49085)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49104);
} else {
return G__49104;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__49085),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
