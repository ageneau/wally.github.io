...
var base_style__$1 = (cljs.core.truth_((function (){var and__4174__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__4174__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__4174__auto__)){
...
var G__63686_63729 = re_com.selection_list.check_clicked(selections,item_id,cljs.core.not((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id))),required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__63686_63729) : on_change.call(null,G__63686_63729));
}
...
var G__63687_63730 = re_com.selection_list.radio_clicked(selections,item_id,required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__63687_63730) : on_change.call(null,G__63687_63730));
}
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__63697){
var map__63698 = p__63697;
var map__63698__$1 = (((((!((map__63698 == null))))?(((((map__63698.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63698.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63698):map__63698);
var args = map__63698__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var multi_select_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63698__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(item_renderer)?(function (p1__63691_SHARP_){
return (item_renderer.cljs$core$IFn$_invoke$arity$8 ? item_renderer.cljs$core$IFn$_invoke$arity$8(p1__63691_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_) : item_renderer.call(null,p1__63691_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_));
}):(cljs.core.truth_(multi_select_QMARK_)?(function (p1__63692_SHARP_){
return re_com.selection_list.as_checked(p1__63692_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
}):(function (p1__63693_SHARP_){
return re_com.selection_list.as_radio(p1__63693_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
}))),choices);
...
var len__4789__auto___63746 = arguments.length;
var i__4790__auto___63747 = (0);
while(true){
if((i__4790__auto___63747 < len__4789__auto___63746)){
args__4795__auto__.push((arguments[i__4790__auto___63747]));

var G__63748 = (i__4790__auto___63747 + (1));
i__4790__auto___63747 = G__63748;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__4796__auto__);
});

(re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__63709){
var map__63710 = p__63709;
...
return (function() { 
var G__63749__delegate = function (p__63716){
var map__63717 = p__63716;
var map__63717__$1 = (((((!((map__63717 == null))))?(((((map__63717.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63717.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__63717):map__63717);
var args__$1 = map__63717__$1;
...
var G__63751__i = 0, G__63751__a = new Array(arguments.length -  0);
while (G__63751__i < G__63751__a.length) {G__63751__a[G__63751__i] = arguments[G__63751__i + 0]; ++G__63751__i;}
  p__63716 = new cljs.core.IndexedSeq(G__63751__a,0,null);
} 
return G__63749__delegate.call(this,p__63716);};
G__63749.cljs$lang$maxFixedArity = 0;
G__63749.cljs$lang$applyTo = (function (arglist__63752){
var p__63716 = cljs.core.seq(arglist__63752);
return G__63749__delegate(p__63716);
});
...
/** @this {Function} */
(re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq63705){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq63705));
}));
