...
return [(function (){var pred__46976 = cljs.core.instance_QMARK_;
var expr__46977 = reactive_val;
if(cljs.core.truth_((pred__46976.cljs$core$IFn$_invoke$arity$2 ? pred__46976.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__46977) : pred__46976.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RAtom,expr__46977)))){
return "ra";
} else {
if(cljs.core.truth_((pred__46976.cljs$core$IFn$_invoke$arity$2 ? pred__46976.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__46977) : pred__46976.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.RCursor,expr__46977)))){
return "rc";
} else {
if(cljs.core.truth_((pred__46976.cljs$core$IFn$_invoke$arity$2 ? pred__46976.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__46977) : pred__46976.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Reaction,expr__46977)))){
return "rx";
} else {
if(cljs.core.truth_((pred__46976.cljs$core$IFn$_invoke$arity$2 ? pred__46976.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__46977) : pred__46976.call(null,day8.re_frame_10x.inlined_deps.reagent.v0v9v1.reagent.ratom.Track,expr__46977)))){
return "tr";
} else {
return "other";
}
