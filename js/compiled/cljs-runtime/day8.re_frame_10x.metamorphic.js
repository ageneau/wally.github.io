...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__52787_SHARP_){
return (((beginning <= new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__52787_SHARP_))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__52787_SHARP_) <= ending)));
}));
});
...
var G__52824 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
return ((cljs.core.not_any_QMARK_((function (p1__52825_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("sub","dispose","sub/dispose",365440536),p1__52825_SHARP_);
...
return cljs.core.assoc_in(state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"operation","operation",-1267664310).cljs$core$IFn$_invoke$arity$1(trace),new cljs.core.Keyword(null,"layer","layer",-1601820589)], null),(cljs.core.truth_(cljs.core.some((function (p1__52826_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(app_db_id,p1__52826_SHARP_);
...
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__52827){
var vec__52828 = p__52827;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52828,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52828,(1),null);
...
var new_state = (function (){var G__52832 = new cljs.core.Keyword(null,"op-type","op-type",-1636141668).cljs$core$IFn$_invoke$arity$1(trace);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__52832__$1)].join('')));
...
var second_pass = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (all_state,p__52839){
var vec__52840 = p__52839;
var sub_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52840,(0),null);
var sub_state = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52840,(1),null);
