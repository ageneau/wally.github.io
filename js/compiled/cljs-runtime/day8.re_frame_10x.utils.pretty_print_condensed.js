...
return [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(string,(0),(function (){var G__50683 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50679__$1)].join('')));
...
var G__50734 = clojure.string.replace(s,match,trunc_prefix);
var G__50735 = limit;
var G__50736 = match;
var G__50737 = trunc_prefix;
s = G__50734;
limit = G__50735;
match = G__50736;
trunc_prefix = G__50737;
continue;
}
}
break;
...
var prefix = (function (){var G__50687 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__50687,"\u2026/"].join('');
} else {
return G__50687;
}
})();
...
var vec__50697 = day8.re_frame_10x.utils.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50697,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50697,(1),null);
...
var or__4185__auto__ = (function (){var G__50719 = form.name;
if((G__50719 == null)){
return null;
} else {
return clojure.string.replace(G__50719,/(^.*\$)(.*)/,"$2");
}
})();
...
var G__50721 = obj;
var G__50722 = writer;
var G__50723 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(opts,new cljs.core.Keyword(null,"fallback-impl","fallback-impl",-1501286995),day8.re_frame_10x.utils.pretty_print_condensed.pr_writer_impl);
return (alt_impl.cljs$core$IFn$_invoke$arity$3 ? alt_impl.cljs$core$IFn$_invoke$arity$3(G__50721,G__50722,G__50723) : alt_impl.call(null,G__50721,G__50722,G__50723));
} else {
...
var seq__50724 = cljs.core.seq(cljs.core.next(objs));
var chunk__50725 = null;
var count__50726 = (0);
var i__50727 = (0);
while(true){
if((i__50727 < count__50726)){
var obj = chunk__50725.cljs$core$IIndexed$_nth$arity$2(null,i__50727);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__50743 = seq__50724;
var G__50744 = chunk__50725;
var G__50745 = count__50726;
var G__50746 = (i__50727 + (1));
seq__50724 = G__50743;
chunk__50725 = G__50744;
count__50726 = G__50745;
i__50727 = G__50746;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__50724);
if(temp__5735__auto__){
var seq__50724__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50724__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__50724__$1);
var G__50747 = cljs.core.chunk_rest(seq__50724__$1);
var G__50748 = c__4609__auto__;
var G__50749 = cljs.core.count(c__4609__auto__);
var G__50750 = (0);
seq__50724 = G__50747;
chunk__50725 = G__50748;
count__50726 = G__50749;
i__50727 = G__50750;
continue;
} else {
var obj = cljs.core.first(seq__50724__$1);
cljs.core._write(writer," ");

day8.re_frame_10x.utils.pretty_print_condensed.pr_writer(obj,writer,opts);


var G__50751 = cljs.core.next(seq__50724__$1);
var G__50752 = null;
var G__50753 = (0);
var G__50754 = (0);
seq__50724 = G__50751;
chunk__50725 = G__50752;
count__50726 = G__50753;
i__50727 = G__50754;
continue;
}
} else {
...
var len__4789__auto___50762 = arguments.length;
var i__4790__auto___50763 = (0);
while(true){
if((i__4790__auto___50763 < len__4789__auto___50762)){
args__4795__auto__.push((arguments[i__4790__auto___50763]));

var G__50764 = (i__4790__auto___50763 + (1));
i__4790__auto___50763 = G__50764;
continue;
} else {
}
break;
...
/** @this {Function} */
(day8.re_frame_10x.utils.pretty_print_condensed.pr_str_truncated.cljs$lang$applyTo = (function (seq50728){
var G__50729 = cljs.core.first(seq50728);
var seq50728__$1 = cljs.core.next(seq50728);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50729,seq50728__$1);
}));
