...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__47399 = cljs.core.second(format);
var G__47400 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__47399,G__47400) : ajax.easy.keyword_response_format_element.call(null,G__47399,G__47400));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47405_SHARP_){
return ajax.easy.keyword_response_format_element(p1__47405_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__47411){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47412__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47412__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47412__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__47414){
var vec__47415 = p__47414;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47415,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47415,(1),null);
var fexpr__47418_47428 = (cljs.core.truth_(ok)?h:e);
(fexpr__47418_47428.cljs$core$IFn$_invoke$arity$1 ? fexpr__47418_47428.cljs$core$IFn$_invoke$arity$1(result) : fexpr__47418_47428.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__47419){
...
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47420__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47420__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47420__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47420__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47420__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
