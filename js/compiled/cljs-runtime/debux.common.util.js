...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__61128_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__61128_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__61127_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__61127_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__61129_SHARP_){
return (((p1__61129_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__61129_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__61132,mapping){
...
var state = map__61133__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61133__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61133__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61133__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__61130_SHARP_){
if((p1__61130_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__61130_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__61190 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__61192 = clojure.zip.next(loc);
loc = G__61192;
continue;
}
}
...
var len__4789__auto___61205 = arguments.length;
var i__4790__auto___61206 = (0);
while(true){
if((i__4790__auto___61206 < len__4789__auto___61205)){
args__4795__auto__.push((arguments[i__4790__auto___61206]));

var G__61207 = (i__4790__auto___61206 + (1));
i__4790__auto___61206 = G__61207;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__61141){
var vec__61142 = p__61141;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61142,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq61139){
var G__61140 = cljs.core.first(seq61139);
var seq61139__$1 = cljs.core.next(seq61139);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__61140,seq61139__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__61145_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__61145_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__61147_61209 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__61148_61210 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__61149_61211 = true;
var _STAR_print_fn_STAR__temp_val__61150_61212 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__61149_61211);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__61150_61212);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__61148_61210);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__61147_61209);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__61146_SHARP_){
return debux.common.util.prepend_bars(p1__61146_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__61213 = cljs.core.next(opts__$1);
var G__61214 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__61213;
acc = G__61214;
continue;
} else {
if(typeof f === 'string'){
var G__61215 = cljs.core.next(opts__$1);
var G__61216 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__61215;
acc = G__61216;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__61217 = cljs.core.nnext(opts__$1);
var G__61218 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__61217;
acc = G__61218;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__61219 = cljs.core.next(opts__$1);
var G__61220 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__61219;
acc = G__61220;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__61155 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__61155.cljs$core$IFn$_invoke$arity$1 ? fexpr__61155.cljs$core$IFn$_invoke$arity$1(f) : fexpr__61155.call(null,f));
})())){
var G__61225 = cljs.core.next(opts__$1);
var G__61226 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__61225;
acc = G__61226;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__61156 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__61156.cljs$core$IFn$_invoke$arity$1 ? fexpr__61156.cljs$core$IFn$_invoke$arity$1(f) : fexpr__61156.call(null,f));
})())){
var G__61227 = cljs.core.nnext(opts__$1);
var G__61228 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__61227;
acc = G__61228;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__61229 = cljs.core.next(opts__$1);
var G__61230 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__61229;
acc = G__61230;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__61157){
var vec__61158 = p__61157;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61158,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61158,(1),null);
...
var G__61164 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__61163 = (function (){var fexpr__61165 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__61165.cljs$core$IFn$_invoke$arity$1 ? fexpr__61165.cljs$core$IFn$_invoke$arity$1(form) : fexpr__61165.call(null,form));
})();
return (fexpr__61163.cljs$core$IFn$_invoke$arity$1 ? fexpr__61163.cljs$core$IFn$_invoke$arity$1(G__61164) : fexpr__61163.call(null,G__61164));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__61171 = quoted_form;
var G__61172 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__61171,G__61172) : debux.common.util.remove_d.call(null,G__61171,G__61172));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__61181 = quoted_form;
var G__61182 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__61181,G__61182) : debux.common.util.remove_d.call(null,G__61181,G__61182));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__61232__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__61184 = quoted_form;
var G__61185 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__61184,G__61185) : debux.common.util.remove_d.call(null,G__61184,G__61185));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__61233__i < G__61233__a.length) {G__61233__a[G__61233__i] = arguments[G__61233__i + 0]; ++G__61233__i;}
  arg = new cljs.core.IndexedSeq(G__61233__a,0,null);
} 
return G__61232__delegate.call(this,arg);};
G__61232.cljs$lang$maxFixedArity = 0;
G__61232.cljs$lang$applyTo = (function (arglist__61234){
var arg = cljs.core.seq(arglist__61234);
return G__61232__delegate(arg);
});
...
var G__61235 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__61235;
continue;
} else {
...
var G__61236 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__61236;
continue;
} else {
var G__61237 = clojure.zip.next(loc);
loc = G__61237;
continue;
