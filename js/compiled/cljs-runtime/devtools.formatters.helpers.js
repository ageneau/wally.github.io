...
var G__42571 = devtools.prefs.pref(v);
v = G__42571;
continue;
} else {
return v;
...
}catch (e42532){var _e__40091__auto__ = e42532;
return false;
}})();
...
}catch (e42538){var _e__40091__auto__ = e42538;
return false;
}})();
...
}catch (e42540){var _e__40091__auto__ = e42540;
return false;
}}
}
});
...
var vec__42549 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42549,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42549,(1),null);
...
return cljs.core.some((function (p1__42565_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__42565_SHARP_);
}),template);
});
