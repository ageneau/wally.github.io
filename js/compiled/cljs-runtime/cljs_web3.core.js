 ...
 *   user> 0.2.0
 */
cljs_web3.core.version_api = cljs_web3.utils.prop_or_clb_fn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["version","api"], 0));
/**
 ...
 */
cljs_web3.core.version_node = cljs_web3.utils.prop_or_clb_fn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["version","node"], 0));
/**
 ...
 *   user> 3
 */
cljs_web3.core.version_network = cljs_web3.utils.prop_or_clb_fn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["version","network"], 0));
/**
 ...
 *   user> 0x3f
 */
cljs_web3.core.version_ethereum = cljs_web3.utils.prop_or_clb_fn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["version","ethereum"], 0));
/**
 ...
 *   user> 20
 */
cljs_web3.core.version_whisper = cljs_web3.utils.prop_or_clb_fn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["version","whisper"], 0));
/**
...
return cljs_web3.utils.js_apply.cljs$core$IFn$_invoke$arity$2(web3,"isConnected");
});
/**
...
return cljs_web3.core.sha3.cljs$core$IFn$_invoke$arity$2(string,null);
}));

(cljs_web3.core.sha3.cljs$core$IFn$_invoke$arity$2 = (function (string,options){
return cljs_web3.core.sha3.cljs$core$IFn$_invoke$arity$3(Web3,string,options);
}));

(cljs_web3.core.sha3.cljs$core$IFn$_invoke$arity$3 = (function (Web3,string,options){
return cljs_web3.utils.js_prototype_apply(Web3,"sha3",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [string,options], null));
}));
...
return cljs_web3.core.to_hex.cljs$core$IFn$_invoke$arity$2(Web3,any);
}));

(cljs_web3.core.to_hex.cljs$core$IFn$_invoke$arity$2 = (function (Web3,any){
return cljs_web3.utils.js_prototype_apply(Web3,"toHex",new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [any], null));
}));
...
return cljs_web3.core.to_ascii.cljs$core$IFn$_invoke$arity$2(Web3,hex_string);
}));

(cljs_web3.core.to_ascii.cljs$core$IFn$_invoke$arity$2 = (function (Web3,hex_string){
return cljs_web3.utils.js_prototype_apply(Web3,"toAscii",new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [hex_string], null));
}));
...
return cljs_web3.core.from_ascii.cljs$core$IFn$_invoke$arity$2(string,null);
}));

(cljs_web3.core.from_ascii.cljs$core$IFn$_invoke$arity$2 = (function (string,padding){
return cljs_web3.core.from_ascii.cljs$core$IFn$_invoke$arity$3(Web3,string,padding);
}));

(cljs_web3.core.from_ascii.cljs$core$IFn$_invoke$arity$3 = (function (Web3,string,padding){
return cljs_web3.utils.js_prototype_apply(Web3,"fromAscii",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [string,padding], null));
}));
...
return cljs_web3.core.to_decimal.cljs$core$IFn$_invoke$arity$2(Web3,hex_string);
}));

(cljs_web3.core.to_decimal.cljs$core$IFn$_invoke$arity$2 = (function (Web3,hex_string){
return cljs_web3.utils.js_prototype_apply(Web3,"toDecimal",new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [hex_string], null));
}));
...
return cljs_web3.core.from_decimal.cljs$core$IFn$_invoke$arity$2(Web3,number);
}));

(cljs_web3.core.from_decimal.cljs$core$IFn$_invoke$arity$2 = (function (Web3,number){
return cljs_web3.utils.js_prototype_apply(Web3,"fromDecimal",new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [number], null));
}));
...
return cljs_web3.core.from_wei.cljs$core$IFn$_invoke$arity$3(Web3,number,unit);
}));

(cljs_web3.core.from_wei.cljs$core$IFn$_invoke$arity$3 = (function (Web3,number,unit){
return cljs_web3.utils.js_prototype_apply(Web3,"fromWei",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [number,cljs.core.name(unit)], null));
}));
...
return cljs_web3.core.to_wei.cljs$core$IFn$_invoke$arity$3(Web3,number,unit);
}));

(cljs_web3.core.to_wei.cljs$core$IFn$_invoke$arity$3 = (function (Web3,number,unit){
return cljs_web3.utils.js_prototype_apply(Web3,"toWei",new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [number,cljs.core.name(unit)], null));
}));
...
return cljs_web3.core.to_big_number.cljs$core$IFn$_invoke$arity$2(Web3,number_or_hex_string);
}));

(cljs_web3.core.to_big_number.cljs$core$IFn$_invoke$arity$2 = (function (Web3,number_or_hex_string){
return cljs_web3.utils.js_prototype_apply(Web3,"toBigNumber",new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [number_or_hex_string], null));
}));
...
return cljs_web3.core.pad_left.cljs$core$IFn$_invoke$arity$3(string,chars,null);
}));

(cljs_web3.core.pad_left.cljs$core$IFn$_invoke$arity$3 = (function (string,chars,sign){
return cljs_web3.core.pad_left.cljs$core$IFn$_invoke$arity$4(Web3,string,chars,sign);
}));

(cljs_web3.core.pad_left.cljs$core$IFn$_invoke$arity$4 = (function (Web3,string,chars,sign){
return cljs_web3.utils.js_prototype_apply(Web3,"padLeft",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [string,chars,sign], null));
}));
...
return cljs_web3.core.pad_right.cljs$core$IFn$_invoke$arity$3(string,chars,null);
}));

(cljs_web3.core.pad_right.cljs$core$IFn$_invoke$arity$3 = (function (string,chars,sign){
return cljs_web3.core.pad_right.cljs$core$IFn$_invoke$arity$4(Web3,string,chars,sign);
}));

(cljs_web3.core.pad_right.cljs$core$IFn$_invoke$arity$4 = (function (Web3,string,chars,sign){
return cljs_web3.utils.js_prototype_apply(Web3,"padRight",new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [string,chars,sign], null));
}));
...
return cljs_web3.core.address_QMARK_.cljs$core$IFn$_invoke$arity$2(Web3,address);
}));

(cljs_web3.core.address_QMARK_.cljs$core$IFn$_invoke$arity$2 = (function (Web3,address){
return cljs_web3.utils.js_prototype_apply(Web3,"isAddress",new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [address], null));
}));
...
return cljs_web3.core.reset.cljs$core$IFn$_invoke$arity$2(web3,false);
}));

(cljs_web3.core.reset.cljs$core$IFn$_invoke$arity$2 = (function (web3,keep_is_syncing_QMARK_){
return cljs_web3.utils.js_apply.cljs$core$IFn$_invoke$arity$3(web3,"reset",new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [keep_is_syncing_QMARK_], null));
}));
...
return cljs_web3.utils.js_apply.cljs$core$IFn$_invoke$arity$3(web3,"setProvider",new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [provider], null));
});
/**
 ...
 */
cljs_web3.core.web3 = (function cljs_web3$core$web3(){
return (new goog.object.getValueByKeys(window,"web3","constructor")(cljs_web3.core.current_provider(goog.object.get(window,"web3"))));
});
...
return cljs_web3.core.create_web3.cljs$core$IFn$_invoke$arity$2(Web3,url);
}));

(cljs_web3.core.create_web3.cljs$core$IFn$_invoke$arity$2 = (function (Web3,url){
return (new Web3(cljs_web3.core.http_provider(Web3,url)));
}));

(cljs_web3.core.create_web3.cljs$lang$maxFixedArity = 2);


//# sourceMappingURL=cljs_web3.core.js.map
