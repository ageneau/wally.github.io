...
var G__50293 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__50293;
continue;
} else {
var G__50294 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__50294;
continue;
}
} else {
var G__50295 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__50295;
continue;
}
}
...
var G__50287 = zloc;
var G__50288 = (function (){var G__50289 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__50290 = zloc;
var G__50290__$1 = (((G__50290 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__50290) : rewrite_clj.zip.node.call(null,G__50290)));
if((G__50290__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__50290__$1) : zprint.zutil.edn_STAR_.call(null,G__50290__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__50289) : rewrite_clj.zip.root.call(null,G__50289));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__50287,G__50288) : rewrite_clj.zip.replace.call(null,G__50287,G__50288));
});
/**
...
var G__50306 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__50306;
continue;
}
break;
...
var G__50307 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__50308 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__50307;
out = G__50308;
continue;
} else {
...
var G__50311 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__50312 = cljs.core.next(new_loc);
var G__50313 = replaced_loc;
nloc = G__50311;
new_loc = G__50312;
last_loc = G__50313;
continue;
...
return zprint.rewrite.sort_val((function (){var G__50291 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__50291) : rewrite_clj.zip.down.call(null,G__50291));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__50292_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__50292_SHARP_) : rewrite_clj.zip.tag.call(null,p1__50292_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__50292_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__50292_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
