...
if((c === "\n")){
var G__49709 = escape_QMARK_;
var G__49710 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__49709;
lines = G__49710;
continue;
} else {
buf.append(c);

var G__49712 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__49713 = lines;
escape_QMARK_ = G__49712;
lines = G__49713;
continue;
...
var G__49706 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__49706) : rewrite_clj.node.string_node.call(null,G__49706));
});
...
var G__49707 = cljs.core.re_pattern(regex);
var G__49708 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__49707,G__49708) : rewrite_clj.node.token_node.call(null,G__49707,G__49708));
});
