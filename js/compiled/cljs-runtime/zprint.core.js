...
var vec__51473 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__51476 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51476,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51476,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51473,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51473,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__51487){
var vec__51488 = p__51487;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51488,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51488,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51491,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51491,(1),null);
...
var vec__51498 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51498,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51498,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51498,(2),null);
var vec__51501 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51501,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51501,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51501,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__51505){
var vec__51506 = p__51505;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51506,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51506,(1),null);
...
var len__4789__auto___51556 = arguments.length;
var i__4790__auto___51557 = (0);
while(true){
if((i__4790__auto___51557 < len__4789__auto___51556)){
args__4795__auto__.push((arguments[i__4790__auto___51557]));

var G__51558 = (i__4790__auto___51557 + (1));
i__4790__auto___51557 = G__51558;
continue;
} else {
}
break;
...
var vec__51517 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51517,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51517,(1),null);
...
var G__51520 = zprint.core.parse_string_all_options(rest_options);
var G__51521 = zprint.core.zprint_str_internal;
var G__51522 = ":parse-string-all? call";
var G__51523 = (function (){var G__51524 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51524) : zprint.zutil.edn_STAR_.call(null,G__51524));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__51520,G__51521,G__51522,G__51523) : zprint.core.process_multiple_forms.call(null,G__51520,G__51521,G__51522,G__51523));
} else {
throw (new Error(":parse-string-all? requires a string!"));
}
} else {
var actual_options = zprint.core.determine_options(rest_options);
var vec__51525 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51525,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51525,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq51509){
var G__51510 = cljs.core.first(seq51509);
var seq51509__$1 = cljs.core.next(seq51509);
var G__51511 = cljs.core.first(seq51509__$1);
var seq51509__$2 = cljs.core.next(seq51509__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51510,G__51511,seq51509__$2);
}));
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq51531){
var G__51532 = cljs.core.first(seq51531);
var seq51531__$1 = cljs.core.next(seq51531);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51532,seq51531__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___51562 = arguments.length;
var i__4790__auto___51563 = (0);
while(true){
if((i__4790__auto___51563 < len__4789__auto___51562)){
args__4795__auto__.push((arguments[i__4790__auto___51563]));

var G__51564 = (i__4790__auto___51563 + (1));
i__4790__auto___51563 = G__51564;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint_str.cljs$lang$applyTo = (function (seq51533){
var G__51534 = cljs.core.first(seq51533);
var seq51533__$1 = cljs.core.next(seq51533);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51534,seq51533__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___51565 = arguments.length;
var i__4790__auto___51567 = (0);
while(true){
if((i__4790__auto___51567 < len__4789__auto___51565)){
args__4795__auto__.push((arguments[i__4790__auto___51567]));

var G__51568 = (i__4790__auto___51567 + (1));
i__4790__auto___51567 = G__51568;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq51535){
var G__51536 = cljs.core.first(seq51535);
var seq51535__$1 = cljs.core.next(seq51535);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51536,seq51535__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___51572 = arguments.length;
var i__4790__auto___51573 = (0);
while(true){
if((i__4790__auto___51573 < len__4789__auto___51572)){
args__4795__auto__.push((arguments[i__4790__auto___51573]));

var G__51578 = (i__4790__auto___51573 + (1));
i__4790__auto___51573 = G__51578;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq51537){
var G__51538 = cljs.core.first(seq51537);
var seq51537__$1 = cljs.core.next(seq51537);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51538,seq51537__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__51540,form){
var vec__51541 = p__51540;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51541,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51541,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51541,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51541,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__51544 = (cljs.core.truth_((function (){var and__4174__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4174__auto__)){
if((indent === (0))){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51544,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51544,(1),null);
...
var forms = (function (){var G__51549 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__51549) : zprint.zutil.edn_STAR_.call(null,G__51549));
})();
