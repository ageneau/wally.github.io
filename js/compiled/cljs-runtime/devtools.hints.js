...
var G__40155 = cljs.core.PersistentArrayMap.EMPTY;
var G__40156 = native_stack_trace;
var G__40157 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__40158 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__40155,G__40156,G__40157,G__40158) : cljs.stacktrace.parse_stacktrace.call(null,G__40155,G__40156,G__40157,G__40158));
});
...
var map__40160 = top_item;
var map__40160__$1 = (((((!((map__40160 == null))))?(((((map__40160.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40160.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40160):map__40160);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40160__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40160__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40160__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e40159){var _e = e40159;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___40198 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___40198)){
var seen_errors_40199 = temp__5733__auto___40198;
if(cljs.core.truth_(seen_errors_40199.has(self))){
} else {
seen_errors_40199.add(self);

var temp__5735__auto___40200 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___40200)){
var sense_40207 = temp__5735__auto___40200;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40207)].join(''));
} else {
}
}
} else {
