...
var len__4789__auto___42885 = arguments.length;
var i__4790__auto___42886 = (0);
while(true){
if((i__4790__auto___42886 < len__4789__auto___42885)){
args__4795__auto__.push((arguments[i__4790__auto___42886]));

var G__42889 = (i__4790__auto___42886 + (1));
i__4790__auto___42886 = G__42889;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42746){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42747,G__42748,seq42746__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42835_SHARP_){
return (!((cljs.core.meta(p1__42835_SHARP_) == null)));
})))){
...
var map__42844 = opts;
var map__42844__$1 = (((((!((map__42844 == null))))?(((((map__42844.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42844.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42844):map__42844);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42844__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42848){var _e__40091__auto__ = e42848;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e42850){var _e__40091__auto__ = e42850;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42866 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42867 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42867);

try{var map__42868 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42868__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42866);
}});
...
var temp__5733__auto___42893 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42893)){
var managed_print_level_42894 = temp__5733__auto___42893;
var _STAR_print_level_STAR__orig_val__42871_42895 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42872_42896 = managed_print_level_42894;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42872_42896);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42870_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42870_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42871_42895);
}} else {
job_fn();
}
