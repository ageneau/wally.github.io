...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k46915,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__46921 = k46915;
var G__46921__$1 = (((G__46921 instanceof cljs.core.Keyword))?G__46921.fqn:null);
switch (G__46921__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k46915,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__46924){
var vec__46925 = p__46924;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46925,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46925,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__46914){
var self__ = this;
var G__46914__$1 = this;
return (new cljs.core.RecordIter((0),G__46914__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__46928 = (function (coll__4436__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__46928(this__4435__auto____$1);
})();
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this46916,other46917){
var self__ = this;
var this46916__$1 = this;
return (((!((other46917 == null)))) && ((this46916__$1.constructor === other46917.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46916__$1.status,other46917.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46916__$1.body,other46917.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46916__$1.status_text,other46917.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46916__$1.headers,other46917.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46916__$1.was_aborted,other46917.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this46916__$1.__extmap,other46917.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__46914){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__46937 = cljs.core.keyword_identical_QMARK_;
var expr__46938 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__46940 = new cljs.core.Keyword(null,"status","status",-1997798413);
var G__46941 = expr__46938;
return (pred__46937.cljs$core$IFn$_invoke$arity$2 ? pred__46937.cljs$core$IFn$_invoke$arity$2(G__46940,G__46941) : pred__46937.call(null,G__46940,G__46941));
})())){
return (new ajax.protocols.Response(G__46914,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__46942 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__46943 = expr__46938;
return (pred__46937.cljs$core$IFn$_invoke$arity$2 ? pred__46937.cljs$core$IFn$_invoke$arity$2(G__46942,G__46943) : pred__46937.call(null,G__46942,G__46943));
})())){
return (new ajax.protocols.Response(self__.status,G__46914,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__46944 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__46945 = expr__46938;
return (pred__46937.cljs$core$IFn$_invoke$arity$2 ? pred__46937.cljs$core$IFn$_invoke$arity$2(G__46944,G__46945) : pred__46937.call(null,G__46944,G__46945));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__46914,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__46946 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__46947 = expr__46938;
return (pred__46937.cljs$core$IFn$_invoke$arity$2 ? pred__46937.cljs$core$IFn$_invoke$arity$2(G__46946,G__46947) : pred__46937.call(null,G__46946,G__46947));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__46914,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__46948 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__46949 = expr__46938;
return (pred__46937.cljs$core$IFn$_invoke$arity$2 ? pred__46937.cljs$core$IFn$_invoke$arity$2(G__46948,G__46949) : pred__46937.call(null,G__46948,G__46949));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__46914,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__46914),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__46914){
var self__ = this;
var this__4438__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__46914,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__46918){
var extmap__4478__auto__ = (function (){var G__46954 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__46918,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__46918)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46954);
} else {
return G__46954;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__46918),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__46918),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__46918),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__46918),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__46918),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
