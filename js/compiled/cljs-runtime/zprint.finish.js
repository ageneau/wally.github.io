...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__48204_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__48204_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__48204_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__48205){
var vec__48208 = p__48205;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48208,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48208,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__48213,s,color,element,idx){
...
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48214__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48214__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48214__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__48218 = (function (){var or__4185__auto__ = color;
...
var fexpr__48217 = (function (){var G__48219 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__48219) : style_map.call(null,G__48219));
})();
return (fexpr__48217.cljs$core$IFn$_invoke$arity$1 ? fexpr__48217.cljs$core$IFn$_invoke$arity$1(G__48218) : fexpr__48217.call(null,G__48218));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__48220){
var vec__48221 = p__48220;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48221,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48221,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48221,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__48224){
var vec__48225 = p__48224;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48225,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48225,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48225,(2),null);
...
var G__48286 = cljs.core.next(ssv);
var G__48287 = (this_ssv == null);
var G__48288 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__48289 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__48286;
doing_nil_QMARK_ = G__48287;
last_elide = G__48288;
out = G__48289;
continue;
}
...
var vec__48231 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48231,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48231,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48231,(2),null);
...
var G__48291 = cljs.core.next(remaining_cvec);
var G__48292 = new_idx;
var G__48293 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__48291;
idx = G__48292;
out = G__48293;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__48240,cursor_vec){
var vec__48241 = p__48240;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48241,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48241,(1),null);
var focus_vec = vec__48241;
...
var vec__48244 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48244,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48244,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__48247){
var vec__48248 = p__48247;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48248,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48248,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__48254,existing_count){
var vec__48255 = p__48254;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48255,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48255,(1),null);
...
return cljs.core.filterv((function (p1__48251_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__48251_SHARP_))));
...
var vec__48265 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48265,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48265,(1),null);
var cvec_element = vec__48265;
if((cvec_element == null)){
var G__48303 = cljs.core.next(cvec_nl);
var G__48304 = (idx + (1));
var G__48305 = start;
var G__48306 = out;
cvec_nl = G__48303;
...
var G__48307 = cljs.core.next(cvec_nl);
var G__48308 = (idx + (1));
var G__48309 = idx;
var G__48310 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__48307;
idx = G__48308;
start = G__48309;
out = G__48310;
...
var G__48311 = cljs.core.next(cvec_nl);
var G__48312 = (idx + (1));
var G__48313 = (idx + (1));
var G__48314 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__48311;
idx = G__48312;
start = G__48313;
out = G__48314;
...
var G__48315 = cljs.core.next(cvec_nl);
var G__48316 = (idx + (1));
var G__48317 = idx;
var G__48318 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__48315;
idx = G__48316;
start = G__48317;
out = G__48318;
...
var G__48319 = cljs.core.next(cvec_nl);
var G__48320 = (idx + (1));
var G__48321 = start;
var G__48322 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__48319;
idx = G__48320;
start = G__48321;
out = G__48322;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__48270_SHARP_,p2__48269_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__48269_SHARP_)){
return cljs.core.reduced(p1__48270_SHARP_);
} else {
return (p1__48270_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__48271,p__48272){
var vec__48273 = p__48271;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48273,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48273,(1),null);
var vec__48276 = p__48272;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48276,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48276,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__48280,cvec,focus_vec){
...
var options = map__48281__$1;
var map__48282 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48281__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48282__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48282__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48282__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48279_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__48279_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
